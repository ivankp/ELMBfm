...
History: ..DEC.02; Henk B&B; For ELMBfw (framework), originally derived from
                             ELMBio v4.2 (general-purpose ELMB CANopen app).
	 ..JUN.03; Henk B&B; ELMBfw v2.0:
	                     - CAN-message reception using interrupt.
			     - New CAN configuration parameters:
			       - autostart (goto Operational at startup)
			       - max bus-off counter
	 ..NOV.04; Henk B&B; ELMBfw v2.1:
	                     - Support for Segmented SDO, with example.
--------------------------------------------------------------------------- */
...
/* Firmware version: ELMB framework firmware version 2.1) */
#define MNFCT_SOFTW_VERSION_CHAR0       'F'
#define MNFCT_SOFTW_VERSION_CHAR1       'W'
#define MNFCT_SOFTW_VERSION_CHAR2       '2'
#define MNFCT_SOFTW_VERSION_CHAR3       '1'
